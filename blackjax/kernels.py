...
class sgld:
    ...
    def __new__(  # type: ignore[misc]
        ...
        def step_fn(rng_key: PRNGKey, state, minibatch: PyTree, step_size: float, temperature: float):
            return step(rng_key, state, grad_estimator, minibatch, step_size, temperature)
